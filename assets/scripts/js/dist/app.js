...
/* harmony import */ var _src_vendors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/vendors.js */ "./scripts/js/src/vendors.js");
/* harmony import */ var _src_vendors_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_src_vendors_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _src_woocommerce_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/woocommerce.js */ "./scripts/js/src/woocommerce.js");
/* harmony import */ var _src_woocommerce_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_src_woocommerce_js__WEBPACK_IMPORTED_MODULE_4__);
...
$(document).ready(function () {
  ...
  $.getJSON(rest_api.get_vendors).fail(function (error) {
    console.log(error);
...
function lr_vendor_list(vendors) {
  var options = {
    valueNames: ['name', 'street_address', 'city', 'state', 'postal_code', 'telephone', 'website', 'vendor_id', {
      data: ['id']
    }],
  ...
  $('.loading-section').hide(); //$('.vendor-list--item').on('click', function(){
...
/******/ 	__webpack_require__.O(undefined, ["styles/dist/app"], () => (__webpack_require__("./scripts/js/app.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["styles/dist/app"], () => (__webpack_require__("./styles/app.scss")))
