...
function lrdesigns_custom_styles(){
    ...
    wp_enqueue_style('allstyles', BLOG_URI.'/assets/styles/dist/app.css', array(), rand());
}
...
function lrdesigns_scripts(){
    wp_register_script('allscripts', BLOG_URI . '/assets/scripts/js/dist/app.js', array(), rand(), false);
